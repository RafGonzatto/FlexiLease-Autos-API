...
class ReserveController {
  async createReserve(req: Request, res: Response) {
    try {
      ...
      const reserves = await service.createReserve( id_user, id_car, start_date, end_date )
  ...
  async findReserves(req: Request, res: Response) {
    try {
        ...
        const service = container.resolve(ReserveService)
        const reserves = await service.getAllReserves(filters, Number(limit), Number(offset));
